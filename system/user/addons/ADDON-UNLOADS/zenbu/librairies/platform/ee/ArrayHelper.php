...
class ArrayHelper
{
	...
	public static function array_filter_by($filter, $value, $array)
	{
	   $output = FALSE;
	...
	/**
	 * Look for a value in an array. Will stop at first encounter.
	 * @param $filter
	 * @param $value
	 * @param $array
	 *
	 * @return array|bool
	 */
	public static function array_find($filter, $value, $array)
	{
		foreach ($array as $key => $val_array)
		{
			if ($val_array[$filter] == $value)
