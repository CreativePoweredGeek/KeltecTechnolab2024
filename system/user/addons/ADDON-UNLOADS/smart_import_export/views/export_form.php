<div class="box panel <?php echo (SIE_APP_VER_L6) ? '' : 'ee6_box' ?>">
            ...
            <div class="se_channel_recieve">
                ...
                <div class="field-wrapper other-general-fields" <?php if(! $edit){ echo 'style="display: none;"'; }?>>
                    ...
                    <div class="d-fields">
                        ...
                        <?php if($seeo === true){ ?>
                        <div class="se_boxes <?php if(isset($data['settings']['general_settings']['seeo']) && $data['settings']['general_settings']['seeo'] == "yes"){echo 'active';}?>">
                            <span>&#10004</span>
                            <input type="checkbox" class="check_fields" name="settings[general_settings][seeo]" value="yes"<?php if(isset($data['settings']['general_settings']['seeo']) && $data['settings']['general_settings']['seeo'] == "yes"){echo 'checked';}?> > <?= lang('seeo');?>
                        </div>
                        <?php }?>

                        <?php if($smart_seo === true){ ?>
                        <div class="se_boxes <?php if(isset($data['settings']['general_settings']['smart_seo']) && $data['settings']['general_settings']['smart_seo'] == "yes"){echo 'active';}?>">
                            <span>&#10004</span>
                            <input type="checkbox" class="check_fields" name="settings[general_settings][smart_seo]" value="yes"<?php if(isset($data['settings']['general_settings']['smart_seo']) && $data['settings']['general_settings']['smart_seo'] == "yes"){echo 'checked';}?> > <?= lang('smart_seo');?>
                        </div>
                        <?php }?>
                        
                        <?php if($structure === true){ ?>
                        <div class="se_boxes <?php if(isset($data['settings']['general_settings']['structure']) && $data['settings']['general_settings']['structure'] == "yes"){echo 'active';}?>">
                            <span>&#10004</span>
                            <input type="checkbox" class="check_fields" name="settings[general_settings][structure]" value="yes"<?php if(isset($data['settings']['general_settings']['structure']) && $data['settings']['general_settings']['structure'] == "yes"){echo 'checked';}?> > <?= lang('structure');?>
                        </div>
                        <?php }?>                        

                        <?php if($transcribe === true){ ?>
                        <div class="se_boxes <?php if(isset($data['settings']['general_settings']['transcribe']) && $data['settings']['general_settings']['transcribe'] == "yes"){echo 'active';}?>">
                            <span>&#10004</span>
                            <input type="checkbox" class="check_fields" name="settings[general_settings][transcribe]" value="yes"<?php if(isset($data['settings']['general_settings']['transcribe']) && $data['settings']['general_settings']['transcribe'] == "yes"){echo 'checked';}?> > <?= lang('transcribe');?>
                        </div>
                        <?php }?>                        
                ...
                <div class="field-wrapper" <?php if(! $edit){ echo 'style="display: none;"'; }?>>
                    ...
                    <fieldset class="col-group se-date-filter hidden">
                        <div class="setting-txt col w-8">
                            ...
                            <em>Starting date of entry to export</em>
                        </div>
                    ...
                    <fieldset class="col-group se-date-filter hidden">
                        <div class="setting-txt col w-8">
                            <h3></span>End Date</h3>
                            <em>Ending date of entry to export</em>
                        </div>
                        <div class="setting-field col w-8 last">
                ...
                <fieldset class="field-wrapper form-ctrls" <?php if(! $edit){ echo 'style="display: none;"'; }?>>
                    <select name="format">
                        ...
                        <option <?php if(isset($data['format']) && $data['format'] == 'JSON'){echo 'selected'; }?>>JSON</option>
                    </select>
