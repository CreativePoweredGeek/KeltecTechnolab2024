...
spl_autoload_register(
    function ($class_name) {
        $phar_path = PATH_THIRD . 'smart_import_export/smart_import_export.phar';
        $phar_stream_path = 'phar://' . $phar_path;
        $tmp_phar_path = sys_get_temp_dir() . '/pharextract/smart_import_export';

        $namespace = 'Zealousweb\SmartImportExport';
