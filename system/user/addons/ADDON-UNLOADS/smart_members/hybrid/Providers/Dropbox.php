...
{ 
	...
	*/
	function initialize() 
	{
		...
		$this->api->authorize_url = "https://api.dropboxapi.com/oauth2/authorize";
	...
	*/
	function getUserProfile()
	{
		...
		try{
			$param =  array('Content-Type: application/json');
			$response = $this->api->api( "users/get_current_account", 'POST', $param);
		}
