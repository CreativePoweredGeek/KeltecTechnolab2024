...
namespace CartThrob\Forms\Settings\Coupons;
...
class SetChannel extends AbstractForm
{
    ...
    public function generate(): array
    {
        $form = [
            [
                ...
                'desc' => 'the_channel_that_stores_coupon_details',
                'caution' => true,
                'fields' => [
                    'coupon_code_channel' => [
                        'name' => 'coupon_code_channel',
                        'type' => 'select',
                        'value' => $this->get('coupon_code_channel'),
                        'choices' => $this->getUsableCouponChannels(),
                        'no_results' => [
        ...
        $form = ['coupons_channel_form_description' => $form];
     ...
     */
    protected function getUsableCouponChannels()
    {
        $used = [];
        ...
        $check = ['discount_channel', 'purchased_items_channel', 'orders_channel', 'product_channel'];
