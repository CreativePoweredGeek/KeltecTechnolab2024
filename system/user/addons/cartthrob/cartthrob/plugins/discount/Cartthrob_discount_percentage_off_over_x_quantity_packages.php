...
class Cartthrob_discount_percentage_off_over_x_quantity_packages extends DiscountPlugin
{
    ...
    public function get_discount()
    {
        ...
        if ($quantity >= abs(Number::sanitize($this->plugin_settings('order_over')))) {
