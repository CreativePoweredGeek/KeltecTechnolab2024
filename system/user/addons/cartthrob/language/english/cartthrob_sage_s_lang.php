...
$lang = [
    // SAGE ERRORS & CONTENT
    'sage_server_title' => 'Opayo Europe Offsite (Server)',
    'sage_overview' => "<p>Opayo is the UK and Ireland's leading independent payment service provider and makes accepting payments online, simple, fast, secure and profitable.</p>
	<h3>When used with Subscriptions</h3>
	<p>You must have both PAYMENT and AUTHENTICATE methods set in your account to use Opayo with the Subscriptions Add-on.</p>
	<h3>Testing</h3>
	<p>IP Address: You need to register any IP address you're using to test or process live transactions with your Opayo Account, or your tests and live transactions will fail. <br />
    ...
    'ct.payments.sage_server.note' => 'Accept credit card payments by redirecting your customers to the Opayo (<a href="https://www.opayo.co.uk/" target="_blank">Opayo</a>) website.',
];
