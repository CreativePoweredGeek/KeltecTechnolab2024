...
$lang = [
    ...
    // Inactive Coupon (used before coupon start date)
    'coupon_expired_msg' => 'The code you entered is expired.',
    // Expired Coupon (used after coupon end date)
    'coupon_global_limit_msg' => 'You are only allowed %d coupon code per order.',
    // Coupon Limit Reached
    'coupon_user_limit_msg' => 'You have already used this coupon code.',
    // If coupons have a limit per customer,
    'coupon_coupon_limit_msg' => 'The code you entered is no longer valid.',
    // If coupons have a limit per coupon,
    ...
    'validation_shipping_phone' => 'Shipping Phone',
    ...
    'cannot_remove_sa_account' => "Cannot remove the Super Admin that's configured for use by CartThrob",
];
