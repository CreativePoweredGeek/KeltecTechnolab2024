...
namespace CartThrob\Dependency\Money\PHPUnit;

use CartThrob\Dependency\Money\Currencies\AggregateCurrencies;
use CartThrob\Dependency\Money\Currencies\BitcoinCurrencies;
use CartThrob\Dependency\Money\Currencies\ISOCurrencies;
use CartThrob\Dependency\Money\Formatter\IntlMoneyFormatter;
use CartThrob\Dependency\Money\Money;
use NumberFormatter;
use CartThrob\Dependency\SebastianBergmann\Comparator\ComparisonFailure;
use function assert;
/**
 ...
 */
final class Comparator extends \CartThrob\Dependency\SebastianBergmann\Comparator\Comparator
{
    private IntlMoneyFormatter $formatter;
    public function __construct()
    {
        parent::__construct();
        $currencies = new AggregateCurrencies([new ISOCurrencies(), new BitcoinCurrencies()]);
