...
use CartThrob\Dependency\Money\Calculator\BcMathCalculator;
...
final class Money implements JsonSerializable
{
    ...
    {
        return new self(self::$calculator::absolute($this->amount), $this->currency);
    }
    ...
    {
        return ['amount' => $this->amount, 'currency' => $this->currency->jsonSerialize()];
    }
    /**
     * @param Money $first
