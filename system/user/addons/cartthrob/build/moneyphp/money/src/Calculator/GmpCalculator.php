...
namespace CartThrob\Dependency\Money\Calculator;

use InvalidArgumentException as CoreInvalidArgumentException;
use CartThrob\Dependency\Money\Calculator;
use CartThrob\Dependency\Money\Exception\InvalidArgumentException;
...
final class GmpCalculator implements Calculator
{
    ...
    public static function divide(string $amount, string $divisor) : string
    {
        ...
        $divisionOfRemainder = gmp_strval(gmp_div_q(gmp_mul($remainder, gmp_init('1' . str_pad('', self::SCALE, '0'))), gmp_init((string) $divisor), GMP_ROUND_MINUSINF));
