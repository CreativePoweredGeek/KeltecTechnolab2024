 ...
 */
namespace CartThrob\Dependency\Carbon\Traits;

use CartThrob\Dependency\Carbon\CarbonInterface;
use CartThrob\Dependency\Carbon\Exceptions\InvalidTypeException;
use CartThrob\Dependency\Carbon\Exceptions\NotLocaleAwareException;
use CartThrob\Dependency\Carbon\Language;
use CartThrob\Dependency\Carbon\Translator;
use CartThrob\Dependency\Carbon\TranslatorStrongTypeInterface;
use Closure;
use CartThrob\Dependency\Symfony\Component\Translation\TranslatorBagInterface;
use CartThrob\Dependency\Symfony\Component\Translation\TranslatorInterface;
use CartThrob\Dependency\Symfony\Contracts\Translation\LocaleAwareInterface;
use CartThrob\Dependency\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
if (\interface_exists('CartThrob\\Dependency\\Symfony\\Contracts\\Translation\\TranslatorInterface') && !\interface_exists('CartThrob\\Dependency\\Symfony\\Component\\Translation\\TranslatorInterface')) {
    \class_alias('CartThrob\\Dependency\\Symfony\\Contracts\\Translation\\TranslatorInterface', 'CartThrob\\Dependency\\Symfony\\Component\\Translation\\TranslatorInterface');
}
/**
 * Trait Localization.
 *
