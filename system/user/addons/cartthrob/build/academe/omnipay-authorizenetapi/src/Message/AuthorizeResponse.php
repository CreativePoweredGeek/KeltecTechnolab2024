...
use CartThrob\Dependency\Academe\AuthorizeNet\Response\Model\TransactionResponse as TransactionResponseModel;
class AuthorizeResponse extends AbstractResponse
{
    ...
    public function isSuccessful()
    {
        ...
        return parent::isSuccessful() && $this->getResponseCode() == TransactionResponseModel::RESPONSE_CODE_APPROVED;
    }
    /**
    ...
    {
        return $this->responseIsSuccessful() && $this->getResponseCode() == TransactionResponseModel::RESPONSE_CODE_PENDING;
    }
    /**
    ...
    {
        return $this->getValue($this->transactionIndex . '.transactionMessages') ?: new TransactionMessages();
    }
    /**
    ...
    {
        return $this->getValue($this->transactionIndex . '.errors') ?: new Errors();
    }
    /**
