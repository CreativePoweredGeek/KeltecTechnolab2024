 ...
 */
use CartThrob\Dependency\Academe\AuthorizeNet\Request\GetTransactionDetails;
class FetchTransactionRequest extends AbstractRequest
{
    ...
    {
        $request = new GetTransactionDetails($this->getAuth(), $this->getTransactionReference());
