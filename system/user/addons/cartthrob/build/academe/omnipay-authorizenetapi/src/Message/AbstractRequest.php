...
use CartThrob\Dependency\Academe\AuthorizeNet\Request\CreateTransaction;
use CartThrob\Dependency\Academe\AuthorizeNet\Request\AbstractRequest as ApiAbstractRequest;
...
abstract class AbstractRequest extends OmnipayAbstractRequest
{
    ...
    {
        $response = $this->httpClient->request($method, $this->getEndpoint(), array('Content-Type' => 'application/json'), \json_encode($data));
        return $response;
    }
    /**
