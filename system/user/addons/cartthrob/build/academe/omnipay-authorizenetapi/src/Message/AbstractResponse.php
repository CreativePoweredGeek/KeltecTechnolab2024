 ...
 */
use CartThrob\Dependency\Omnipay\Common\Message\AbstractResponse as OmnipayAbstractResponse;
use CartThrob\Dependency\Omnipay\Common\Message\RequestInterface;
use CartThrob\Dependency\Academe\AuthorizeNet\Response\Response;
use CartThrob\Dependency\Symfony\Component\PropertyAccess\Exception\ExceptionInterface;
use CartThrob\Dependency\Symfony\Component\PropertyAccess\PropertyAccess;
use CartThrob\Dependency\Symfony\Component\PropertyAccess\PropertyAccessor;
abstract class AbstractResponse extends OmnipayAbstractResponse
{
    ...
    public function getValue($path)
    {
        ...
        // accessor now.
        if (empty($accessor)) {
            $accessor = PropertyAccess::createPropertyAccessorBuilder()->enableMagicCall()->disableExceptionOnInvalidIndex()->getPropertyAccessor();
    ...
    {
        return $this->getValue($this->transactionIndex . '.errors.first.text') ?: $this->getValue($this->transactionIndex . '.transactionMessages.first.text');
    }
    /**
    ...
    {
        return $this->getValue($this->transactionIndex . '.errors.first.code') ?: $this->getValue($this->transactionIndex . '.transactionMessages.first.code');
    }
    /**
