 ...
 */
use CartThrob\Dependency\Omnipay\Common\Message\NotificationInterface;
...
use CartThrob\Dependency\Omnipay\AuthorizeNetApi\Traits\HasGatewayParams;
use CartThrob\Dependency\Academe\AuthorizeNet\ServerRequest\Notification;
use CartThrob\Dependency\Academe\AuthorizeNet\Response\Model\TransactionResponse;
...
class AcceptNotification extends AbstractRequest implements NotificationInterface
{
    ...
    public function __construct(ClientInterface $httpClient, HttpRequest $httpRequest)
    {
        ...
        $this->data = \json_decode($this->payload, \true);
        ...
        $this->signature = $httpRequest->headers->get(static::SIGNATURE_HEADER_NAME);
    }
    /**
    ...
    public function isSignatureValid()
    {
        ...
        $hashedPayload = \strtoupper(\hash_hmac($algorithm, $this->payload, $signatureKey));
