...
abstract class AbstractGateway extends OmnipayAbstractGateway
{
    ...
    {
        return $this->createRequest(\CartThrob\Dependency\Omnipay\AuthorizeNetApi\Message\CaptureRequest::class, $parameters);
    }
    /**
     * Fetch a transaction.
     */
    ...
    {
        return $this->createRequest(\CartThrob\Dependency\Omnipay\AuthorizeNetApi\Message\FetchTransactionRequest::class, $parameters);
    }
    /**
    ...
    {
        return $this->createRequest(\CartThrob\Dependency\Omnipay\AuthorizeNetApi\Message\AcceptNotification::class, $parameters);
    }
}
