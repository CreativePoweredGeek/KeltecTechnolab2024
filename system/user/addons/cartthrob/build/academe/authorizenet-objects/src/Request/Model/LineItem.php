...
class LineItem extends AbstractModel
{
    ...
    protected $unitPrice;
    protected $taxable;
    public function __construct($itemId = null, $name = null, $description = null, $quantity = null, AmountInterface $unitPrice = null, $taxable = null)
    {
        parent::__construct();
    ...
    {
        return $this->hasItemId() || $this->hasName() || $this->hasDescription() || $this->hasQuantity() || $this->hasUnitPrice() || $this->hasTaxable();
    }
