 ...
 */
use CartThrob\Dependency\Academe\AuthorizeNet\Request\Collections\PaymentProfiles;
...
class Profile extends AbstractModel
{
    ...
    public function jsonSerialize()
    {
        ...
        if (!$this->hasMerchantCustomerId() && !$this->hasDescription() && !$this->Email()) {
            throw new \InvalidArgumentException(\sprintf('At least one of merchantCustomerId, description and email must be set; none are set'));
        }
