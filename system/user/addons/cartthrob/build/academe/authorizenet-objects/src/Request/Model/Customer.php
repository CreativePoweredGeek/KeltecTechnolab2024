...
class Customer extends AbstractModel
{
    ...
    protected $taxId;
    public function __construct($customerType = null, $id = null, $email = null, $driversLicense = null, $taxId = null)
    {
        parent::__construct();
    ...
    {
        return $this->hasCustomerType() || $this->hasId() || $this->hasEmail() || $this->hasDriversLicense() || $this->hasTaxId();
    }
