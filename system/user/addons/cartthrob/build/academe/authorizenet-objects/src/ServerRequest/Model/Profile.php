...
class Profile extends AbstractModel
{
    ...
    {
        $data = ['customerProfileId' => $this->getCustomerProfileId(), 'customerPaymentProfileId' => $this->getCustomerPaymentProfileId(), 'customerShippingAddressId' => $this->getCustomerShippingAddressId()];
        return $data;
    }
