...
class NameAddress extends AbstractModel
{
    ...
    protected $faxNumber;
    public function __construct($firstName = null, $lastName = null, $company = null, $address = null, $city = null, $state = null, $zip = null, $country = null)
    {
        parent::__construct();
    ...
    {
        return $this->hasFirstName() || $this->hasLastName() || $this->hasCompany() || $this->hasAddress() || $this->hasCity() || $this->hasState() || $this->hasZip() || $this->hasCountry() || $this->hasPhoneNumber() || $this->hasFaxNumber();
    }
