...
namespace CartThrob\Dependency\Academe\AuthorizeNet\Response;
 ...
 * [ ] clientId
 */
use CartThrob\Dependency\Academe\AuthorizeNet\Response\Collections\Messages;
use CartThrob\Dependency\Academe\AuthorizeNet\Response\Model\TransactionResponse;
use CartThrob\Dependency\Academe\AuthorizeNet\Response\Model\Transaction;
...
class Response extends AbstractModel
{
    ...
    {
        $data = ['refId' => $this->getRefId(), 'resultCode' => $this->getResultCode()];
