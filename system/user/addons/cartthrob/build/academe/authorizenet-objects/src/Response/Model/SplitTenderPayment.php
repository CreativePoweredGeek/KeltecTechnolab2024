...
class SplitTenderPayment extends AbstractModel
{
    ...
    {
        $data = ['transId' => $this->getTransId(), 'responseCode' => $this->getResponseCode(), 'responseToCustomer' => $this->getResponseToCustomer(), 'authCode' => $this->getAuthCode(), 'accountNumber' => $this->getAccountNumber(), 'accountType' => $this->getAccountType()];
