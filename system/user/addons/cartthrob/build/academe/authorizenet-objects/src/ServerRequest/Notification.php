...
namespace CartThrob\Dependency\Academe\AuthorizeNet\ServerRequest;
...
use CartThrob\Dependency\Academe\AuthorizeNet\ServerRequest\Payload\CustomerPaymentProfile;
use CartThrob\Dependency\Academe\AuthorizeNet\ServerRequest\Payload\Fraud;
use CartThrob\Dependency\Academe\AuthorizeNet\ServerRequest\Payload\Payment;
use CartThrob\Dependency\Academe\AuthorizeNet\ServerRequest\Payload\Subscription;
use CartThrob\Dependency\Academe\AuthorizeNet\ServerRequest\Payload\CustomerProfile;
use CartThrob\Dependency\Academe\AuthorizeNet\ServerRequest\Payload\Unknown;
class Notification extends AbstractModel
{
    ...
    {
        $data = ['notificationId' => $this->notificationId, 'eventType' => $this->eventType, 'eventDate' => $this->eventDate, 'webhookId' => $this->webhookId];
        if ($this->payload) {
