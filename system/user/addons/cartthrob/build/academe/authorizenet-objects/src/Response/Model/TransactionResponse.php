...
use CartThrob\Dependency\Academe\AuthorizeNet\Response\Model\PrePaidCard;
use CartThrob\Dependency\Academe\AuthorizeNet\Response\Collections\Errors;
use CartThrob\Dependency\Academe\AuthorizeNet\Response\Collections\UserFields;
use CartThrob\Dependency\Academe\AuthorizeNet\Response\Model\SplitTenderPayments;
class TransactionResponse extends AbstractModel
{
    ...
    {
        $data = ['responseCode' => $this->getResponseCode(), 'rawResponseCode' => $this->getRawResponseCode(), 'authCode' => $this->getAuthCode(), 'avsResultCode' => $this->getAvsResultCode(), 'cvvResultCode' => $this->getCvvResultCode(), 'cavvResultCode' => $this->getCavvResultCode(), 'transId' => $this->getTransId(), 'refTransId' => $this->getRefTransId(), 'transHash' => $this->getTransHash(), 'testRequest' => $this->getTestRequest(), 'accountNumber' => $this->getAccountNumber(), 'entryMode' => $this->getEntryMode(), 'accountType' => $this->getAccountType()];
