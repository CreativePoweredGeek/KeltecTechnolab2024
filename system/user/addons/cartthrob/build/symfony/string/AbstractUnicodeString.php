 ...
 */
namespace CartThrob\Dependency\Symfony\Component\String;

use CartThrob\Dependency\Symfony\Component\String\Exception\ExceptionInterface;
use CartThrob\Dependency\Symfony\Component\String\Exception\InvalidArgumentException;
use CartThrob\Dependency\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    public function snake() : static
    {
        ...
        $str->string = \mb_strtolower(\preg_replace(['/(\\p{Lu}+)(\\p{Lu}\\p{Ll})/u', '/([\\p{Ll}0-9])(\\p{Lu})/u'], 'CartThrob\\Dependency\\1_\\2', $str->string), 'UTF-8');
        return $str;
    }
