...
use CartThrob\Dependency\Doctrine\DBAL\DriverManager;
use CartThrob\Dependency\Symfony\Component\Cache\Adapter\AbstractAdapter;
...
class SessionHandlerFactory
{
    public static function createHandler(object|string $connection, array $options = []) : AbstractSessionHandler
    {
        ...
        switch (\true) {
            ...
            case $connection instanceof \CartThrob\Dependency\Predis\ClientInterface:
