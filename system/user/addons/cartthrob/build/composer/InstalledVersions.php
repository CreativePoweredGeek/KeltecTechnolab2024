 ...
 */
namespace CartThrob\Dependency\Composer;

use CartThrob\Dependency\Composer\Autoload\ClassLoader;
use CartThrob\Dependency\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('CartThrob\\Dependency\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
