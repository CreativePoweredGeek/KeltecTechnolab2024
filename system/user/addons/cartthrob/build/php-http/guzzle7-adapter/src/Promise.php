...
use CartThrob\Dependency\GuzzleHttp\Exception as GuzzleExceptions;
use CartThrob\Dependency\GuzzleHttp\Promise\PromiseInterface;
use CartThrob\Dependency\Http\Adapter\Guzzle7\Exception\UnexpectedValueException;
use CartThrob\Dependency\Http\Client\Exception as HttplugException;
use CartThrob\Dependency\Http\Promise\Promise as HttpPromise;
