...
namespace CartThrob\Dependency\Http\Message\Encoding;

use CartThrob\Dependency\Clue\StreamFilter as Filter;
use CartThrob\Dependency\Http\Message\Decorator\StreamDecorator;
