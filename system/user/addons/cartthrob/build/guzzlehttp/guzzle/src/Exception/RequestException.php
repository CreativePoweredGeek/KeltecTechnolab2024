...
namespace CartThrob\Dependency\GuzzleHttp\Exception;

use CartThrob\Dependency\GuzzleHttp\BodySummarizer;
use CartThrob\Dependency\GuzzleHttp\BodySummarizerInterface;
use CartThrob\Dependency\Psr\Http\Client\RequestExceptionInterface;
