...
use Closure;
use CartThrob\Dependency\Illuminate\Support\Traits\Macroable;
use JsonException;
use CartThrob\Dependency\League\CommonMark\Environment\Environment;
use CartThrob\Dependency\League\CommonMark\Extension\GithubFlavoredMarkdownExtension;
use CartThrob\Dependency\League\CommonMark\Extension\InlinesOnly\InlinesOnlyExtension;
use CartThrob\Dependency\League\CommonMark\GithubFlavoredMarkdownConverter;
use CartThrob\Dependency\League\CommonMark\MarkdownConverter;
use CartThrob\Dependency\Ramsey\Uuid\Codec\TimestampFirstCombCodec;
use CartThrob\Dependency\Ramsey\Uuid\Generator\CombGenerator;
use CartThrob\Dependency\Ramsey\Uuid\Uuid;
use CartThrob\Dependency\Ramsey\Uuid\UuidFactory;
use CartThrob\Dependency\voku\helper\ASCII;
class Str
{
    use Macroable;
    /**
