...
use Closure;
use Exception;
use CartThrob\Dependency\Illuminate\Contracts\Support\Arrayable;
use CartThrob\Dependency\Illuminate\Contracts\Support\Jsonable;
use CartThrob\Dependency\Illuminate\Support\Arr;
use CartThrob\Dependency\Illuminate\Support\Collection;
use CartThrob\Dependency\Illuminate\Support\Enumerable;
use CartThrob\Dependency\Illuminate\Support\HigherOrderCollectionProxy;
use JsonSerializable;
use CartThrob\Dependency\Symfony\Component\VarDumper\VarDumper;
use Traversable;
...
trait EnumeratesValues
{
    ...
    {
        return Collection::make($callbacks)->reduce(function ($carry, $callback) {
