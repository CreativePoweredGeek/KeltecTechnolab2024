 ...
 * Credit Card class
 */
namespace CartThrob\Dependency\Omnipay\Common;

use DateTime;
use DateTimeZone;
use CartThrob\Dependency\Omnipay\Common\Exception\InvalidCreditCardException;
...
class CreditCard
{
    ...
    {
        $requiredParameters = array('number' => 'credit card number', 'expiryMonth' => 'expiration month', 'expiryYear' => 'expiration year');
    ...
    {
        return \trim($this->getBillingFirstName() . ' ' . $this->getBillingLastName());
    }
    /**
    ...
    {
        return \trim($this->getShippingFirstName() . ' ' . $this->getShippingLastName());
    }
    /**
