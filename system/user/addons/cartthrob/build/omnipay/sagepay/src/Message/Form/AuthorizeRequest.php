 ...
 */
use CartThrob\Dependency\Omnipay\SagePay\Message\DirectAuthorizeRequest;
...
class AuthorizeRequest extends DirectAuthorizeRequest
{
     ...
     */
    protected $validFields = ['VendorTxCode' => \true, 'Amount' => \true, 'Currency' => \true, 'Description' => \true, 'SuccessURL' => \true, 'FailureURL' => \true, 'CustomerName' => \false, 'CustomerEMail' => \false, 'VendorEMail' => \false, 'SendEMail' => \false, 'EmailMessage' => \false, 'BillingSurname' => \true, 'BillingFirstnames' => \true, 'BillingAddress1' => \true, 'BillingAddress2' => \false, 'BillingCity' => \true, 'BillingPostCode' => \true, 'BillingCountry' => \true, 'BillingState' => \false, 'BillingPhone' => \false, 'DeliverySurname' => \true, 'DeliveryFirstnames' => \true, 'DeliveryAddress1' => \true, 'DeliveryAddress2' => \false, 'DeliveryCity' => \true, 'DeliveryPostCode' => \true, 'DeliveryCountry' => \true, 'DeliveryState' => \false, 'DeliveryPhone' => \false, 'Basket' => \false, 'AllowGiftAid' => \false, 'ApplyAVSCV2' => \false, 'Apply3DSecure' => \false, 'BillingAgreement' => \false, 'BasketXML' => \false, 'CustomerXML' => \false, 'SurchargeXML' => \false, 'VendorData' => \false, 'ReferrerID' => \false, 'Language' => \false, 'Website' => \false, 'FIRecipientAcctNumber' => \false, 'FIRecipientSurname' => \false, 'FIRecipientPostcode' => \false, 'FIRecipientDoB' => \false];
    /**
    ...
    public function getData()
    {
        ...
        return ['VPSProtocol' => $this->VPSProtocol, 'TxType' => $this->getTxType(), 'Vendor' => $this->getVendor(), 'Crypt' => $this->generateCrypt($this->getCryptData()), 'TestMode' => $this->getTestMode()];
    }
    /**
    ...
    public function getCryptData()
    {
        ...
        if ($this->getAllowGiftAid() !== null) {
            $data['AllowGiftAid'] = (bool) $this->getAllowGiftAid() ? static::ALLOW_GIFT_AID_YES : static::ALLOW_GIFT_AID_NO;
        }
        if ($this->getWebsite() !== null) {
            $data['Website'] = $this->getWebsite();
        }
        if ($sendEmail = $this->getSendEmail() !== null) {
            if ($sendEmail != static::SEND_EMAIL_NONE && $sendEmail != static::SEND_EMAIL_BOTH && $sendEmail != static::SEND_EMAIL_VENDOR) {
        ...
        foreach ($this->validFields as $fieldName => $mandatoryFlag) {
            if ($mandatoryFlag && !isset($data[$fieldName])) {
                throw new InvalidRequestException(\sprintf('The %s parameter is required', $fieldName));
            }
        }
        ...
        // in AbstractRequest.
        if ($data['BillingCountry'] === 'US' && empty($data['BillingState']) || $data['DeliveryCountry'] === 'US' && empty($data['DeliveryState'])) {
            throw new InvalidRequestException('Missing state code for billing or shipping address');
        }
        return $data;
    }
    /**
