...
namespace CartThrob\Dependency\Omnipay\SagePay\Traits;
...
trait ServerNotifyTrait
{
    ...
    public function buildSignature()
    {
        ...
        if ($this->getTxType() !== Response::TXTYPE_TOKEN || $this->getStatus() !== Response::SAGEPAY_STATUS_OK) {
            ...
            $signatureData = \array_merge($signatureData, array(
                // Details for AVSCV2:
    ...
    public function getTransactionStatus()
    {
        ...
        if ($status === Response::SAGEPAY_STATUS_OK || $status === Response::SAGEPAY_STATUS_OK_REPEATED || $status === Response::SAGEPAY_STATUS_AUTHENTICATED || $status === Response::SAGEPAY_STATUS_REGISTERED) {
