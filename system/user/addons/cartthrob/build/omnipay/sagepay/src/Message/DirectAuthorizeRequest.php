...
class DirectAuthorizeRequest extends AbstractRequest
{
     ...
     */
    protected $cardBrandMap = array('mastercard' => 'MC', 'diners_club' => 'DC');
    /**
    ...
    public function getTokenData($data = array())
    {
        ...
        if ($this->getToken() || $this->getCardReference()) {
            ...
            } elseif ($storeToken !== static::STORE_TOKEN_YES && $storeToken !== static::STORE_TOKEN_NO) {
                // A store token to treat as a boolean has been supplied.
                $data['StoreToken'] = (bool) $storeToken ? static::STORE_TOKEN_YES : static::STORE_TOKEN_NO;
            } else {
