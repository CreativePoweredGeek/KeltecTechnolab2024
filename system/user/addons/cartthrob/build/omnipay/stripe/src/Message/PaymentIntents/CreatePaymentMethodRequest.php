 ...
 */
namespace CartThrob\Dependency\Omnipay\Stripe\Message\PaymentIntents;
...
class CreatePaymentMethodRequest extends AbstractRequest
{
    ...
    public function getCardData()
    {
        ...
        return ['exp_month' => $data['exp_month'], 'exp_year' => $data['exp_year'], 'number' => $data['number'], 'cvc' => $data['cvc']];
    }
    /**
    ...
    public function getBillingDetails()
    {
        ...
        return \array_filter(['email' => $data['email'], 'name' => $data['name'], 'address' => \array_filter(['city' => $data['address_city'], 'country' => $data['address_country'], 'line1' => $data['address_line1'], 'line2' => $data['address_line2'], 'postal_code' => $data['address_zip'], 'state' => $data['address_state']])]);
    }
    /**
     * @inheritdoc
     */
