...
class Response extends AbstractResponse implements RedirectResponseInterface
{
    ...
    public function __construct(RequestInterface $request, $data, $headers = [])
    {
        ...
        $this->data = \json_decode($data, \true);
    ...
    protected function cardCan3DS()
    {
        if (isset($this->data['type']) && 'card' === $this->data['type']) {
            if (isset($this->data['card']['three_d_secure']) && \in_array($this->data['card']['three_d_secure'], ['required', 'optional', 'recommended'], \true)) {
                return \true;
            }
        }
        return \false;
    ...
    {
        if (isset($this->data['object']) && 'source' === $this->data['object'] && isset($this->data['type']) && 'three_d_secure' === $this->data['type'] && !empty($this->data['redirect']['url'])) {
