 ...
 */
namespace CartThrob\Dependency\Omnipay\Stripe\Message;
 ...
 */
abstract class AbstractRequest extends \CartThrob\Dependency\Omnipay\Common\Message\AbstractRequest
{
    /**
    ...
    {
        $headers = \array_merge($this->getHeaders(), array('Authorization' => 'Basic ' . \base64_encode($this->getApiKey() . ':')));
        $body = $data ? \http_build_query($data, '', '&') : null;
        $httpResponse = $this->httpClient->request($this->getHttpMethod(), $this->getExpandedEndpoint(), $headers, $body);
