...
use CartThrob\Dependency\Omnipay\Common\AbstractGateway as AbstractOmnipayGateway;
/**
 * Stripe Gateway.
 *
 * Example:
...
abstract class AbstractGateway extends AbstractOmnipayGateway
{
    ...
    {
        return array('apiKey' => '', 'stripeVersion' => null);
    }
    /**
     ...
     */
    public abstract function authorize(array $parameters = array());
    /**
     * Capture Request.
     *
     ...
     * @return \Omnipay\Stripe\Message\AbstractRequest
     */
    public abstract function capture(array $parameters = array());
    /**
     * Purchase request.
     *
     ...
     * @return \Omnipay\Stripe\Message\AbstractRequest
     */
    public abstract function purchase(array $parameters = array());
    /**
     * Refund Request.
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\RefundRequest', $parameters);
    }
    /**
     * Void a transaction.
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\VoidRequest', $parameters);
    }
    /**
     * Fetch a transaction.
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchTransactionRequest', $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchBalanceTransactionRequest', $parameters);
    }
    //
    // Application Fees
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchApplicationFeeRequest', $parameters);
    }
    //
    // Transfers
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\Transfers\\CreateTransferRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\Transfers\\FetchTransferRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\Transfers\\UpdateTransferRequest', $parameters);
    }
    /**
     * List Transfers
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\Transfers\\ListTransfersRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\Transfers\\CreateTransferReversalRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\Transfers\\FetchTransferReversalRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\Transfers\\UpdateTransferReversalRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\Transfers\\ListTransferReversalsRequest', $parameters);
    }
    //
    // Cards
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CreateCardRequest', $parameters);
    }
    /**
     * Update Card.
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\UpdateCardRequest', $parameters);
    }
    /**
     * Delete a card.
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\DeleteCardRequest', $parameters);
    }
    //
    // Customers
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CreateCustomerRequest', $parameters);
    }
    /**
     * Fetch Customer.
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchCustomerRequest', $parameters);
    }
    /**
     * Update Customer.
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\UpdateCustomerRequest', $parameters);
    }
    /**
     * Delete a customer.
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\DeleteCustomerRequest', $parameters);
    }
    /**
     * Create Plan
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CreatePlanRequest', $parameters);
    }
    /**
     * Fetch Plan
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchPlanRequest', $parameters);
    }
    /**
     * Delete Plan
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\DeletePlanRequest', $parameters);
    }
    /**
     * List Plans
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\ListPlansRequest', $parameters);
    }
    /**
     * Create Subscription
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CreateSubscriptionRequest', $parameters);
    }
    /**
     * Fetch Subscription
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchSubscriptionRequest', $parameters);
    }
    /**
     * Update Subscription
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\UpdateSubscriptionRequest', $parameters);
    }
    /**
     * Cancel Subscription
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CancelSubscriptionRequest', $parameters);
    }
    /**
     * Fetch Event
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchEventRequest', $parameters);
    }
    /**
     * Fetch Invoice Lines
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchInvoiceLinesRequest', $parameters);
    }
    /**
     * Fetch Invoice
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchInvoiceRequest', $parameters);
    }
    /**
     * List Invoices
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\ListInvoicesRequest', $parameters);
    }
    /**
     * Create Invoice Item
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CreateInvoiceItemRequest', $parameters);
    }
    /**
     * Fetch Invoice Item
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchInvoiceItemRequest', $parameters);
    }
    /**
     * Delete Invoice Item
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\DeleteInvoiceItemRequest', $parameters);
    }
}
