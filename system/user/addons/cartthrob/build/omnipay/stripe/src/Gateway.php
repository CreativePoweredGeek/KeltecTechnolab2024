...
class Gateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\AuthorizeRequest', $parameters);
    }
    /**
     * @inheritdoc
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CaptureRequest', $parameters);
    }
    /**
     * @inheritdoc
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PurchaseRequest', $parameters);
    }
    /**
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchChargeRequest', $parameters);
    }
    //
    // Cards
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CreateTokenRequest', $parameters);
    }
    /**
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchTokenRequest', $parameters);
    }
    /**
     * Create Plan
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchSubscriptionSchedulesRequest', $parameters);
    }
    /**
     * Fetch Event
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CreateSourceRequest', $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\AttachSourceRequest', $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\DetachSourceRequest', $parameters);
    }
    /**
     * @param array $parameters
     * @return \Omnipay\Stripe\Message\FetchSourceRequest
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchSourceRequest', $parameters);
    }
    /**
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CompletePurchaseRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\CreateCouponRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\FetchCouponRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\DeleteCouponRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\UpdateCouponRequest', $parameters);
    }
    /**
     * @param array $parameters
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\ListCouponsRequest', $parameters);
    }
}
