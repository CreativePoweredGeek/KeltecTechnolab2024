 ...
 */
namespace CartThrob\Dependency\Omnipay\Stripe\Message\Transfers;

use CartThrob\Dependency\Omnipay\Common\Exception\InvalidRequestException;
use CartThrob\Dependency\Omnipay\Stripe\Message\AuthorizeRequest;
/**
...
class CreateTransferRequest extends AuthorizeRequest
{
    ...
    public function getData()
    {
        ...
        $data = array('amount' => $this->getAmountInteger(), 'currency' => \strtolower($this->getCurrency()), 'destination' => $this->getDestination());
        if ($this->getMetadata()) {
