...
class PaymentIntentsGateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\AuthorizeRequest', $parameters);
    }
    /**
     * @inheritdoc
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\CaptureRequest', $parameters);
    }
    /**
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\ConfirmPaymentIntentRequest', $parameters);
    }
    /**
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\CancelPaymentIntentRequest', $parameters);
    }
    /**
     * @inheritdoc
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\PurchaseRequest', $parameters);
    }
    /**
     * @inheritdoc
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\FetchPaymentIntentRequest', $parameters);
    }
    //
    // Cards
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\FetchPaymentMethodRequest', $parameters);
    }
    /**
     * @inheritdoc
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\CreatePaymentMethodRequest', $parameters);
    }
    /**
     * @inheritdoc
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\AttachPaymentMethodRequest', $parameters);
    }
    /**
     * @inheritdoc
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\UpdatePaymentMethodRequest', $parameters);
    }
    /**
     * @inheritdoc
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\PaymentIntents\\DetachPaymentMethodRequest', $parameters);
    }
    // Setup Intent
    /**
     * @inheritdoc
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\SetupIntents\\CreateSetupIntentRequest', $parameters);
    }
    /**
     * @inheritdoc
     *
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\Stripe\\Message\\SetupIntents\\RetrieveSetupIntentRequest', $parameters);
    }
}
