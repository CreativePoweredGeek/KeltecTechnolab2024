...
namespace CartThrob\Dependency\Omnipay\PayPal\Support\InstantUpdateApi;
...
class BillingAgreement
{
     ...
     * @var array
     */
    protected $types = array('single' => 'MerchantInitiatedBillingSingleAgreement', 'recurring' => 'MerchantInitiatedBilling');
    /** @var string */
    private $type;
    /** @var string */
    private $description;
