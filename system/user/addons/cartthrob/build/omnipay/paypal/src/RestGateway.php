...
use CartThrob\Dependency\Omnipay\PayPal\Message\ProAuthorizeRequest;
use CartThrob\Dependency\Omnipay\PayPal\Message\CaptureRequest;
use CartThrob\Dependency\Omnipay\PayPal\Message\RefundRequest;
...
class RestGateway extends AbstractGateway
{
    ...
    {
        return array('clientId' => '', 'secret' => '', 'token' => '', 'testMode' => \false);
    }
    //
     ...
     * @return string
     */
    public function getToken($createIfNeeded = \true)
    {
        if ($createIfNeeded && !$this->hasToken()) {
            ...
            if ($response->isSuccessful()) {
                ...
                if (isset($data['access_token'])) {
                    ...
                    $this->setTokenExpires(\time() + $data['expires_in']);
                }
            }
        }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestTokenRequest', array());
    }
    ...
    public function hasToken()
    {
        ...
        return !empty($token) && \time() < $expires;
    }
     ...
     * @return \CartThrob\Dependency\Omnipay\PayPal\Message\AbstractRestRequest
     */
    public function createRequest($class, array $parameters = array())
    {
        if (!$this->hasToken() && $class != 'CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestTokenRequest') {
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestPurchaseRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestFetchPurchaseRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestListPurchaseRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestCompletePurchaseRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestAuthorizeRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestVoidRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestCaptureRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestRefundCaptureRequest', $parameters);
    }
    //
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestFetchTransactionRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestRefundRequest', $parameters);
    }
    //
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestCreateCardRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestDeleteCardRequest', $parameters);
    }
    //
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestCreatePlanRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestUpdatePlanRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestListPlanRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestCreateSubscriptionRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestCompleteSubscriptionRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestCancelSubscriptionRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestSuspendSubscriptionRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestReactivateSubscriptionRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\RestSearchTransactionRequest', $parameters);
    }
