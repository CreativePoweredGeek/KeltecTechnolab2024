...
class ExpressGateway extends ProGateway
{
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\ExpressAuthorizeRequest', $parameters);
    }
    public function completeAuthorize(array $parameters = array())
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\ExpressCompleteAuthorizeRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\ExpressCompletePurchaseRequest', $parameters);
    }
    public function void(array $parameters = array())
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\ExpressVoidRequest', $parameters);
    }
    public function fetchCheckout(array $parameters = array())
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\ExpressFetchCheckoutRequest', $parameters);
    }
    /**
    ...
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\ExpressTransactionSearchRequest', $parameters);
    }
    public function order(array $parameters = array())
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\ExpressOrderRequest', $parameters);
    }
    public function completeOrder(array $parameters = array())
    {
        return $this->createRequest('CartThrob\\Dependency\\Omnipay\\PayPal\\Message\\ExpressCompleteOrderRequest', $parameters);
    }
}
