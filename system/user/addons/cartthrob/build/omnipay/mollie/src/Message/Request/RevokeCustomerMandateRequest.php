...
use CartThrob\Dependency\Omnipay\Mollie\Message\Response\RevokeCustomerMandateResponse;
/**
...
class RevokeCustomerMandateRequest extends AbstractMollieRequest
{
    ...
    {
        $response = $this->sendRequest(self::DELETE, "/customers/{$this->getCustomerReference()}/mandates/{$this->getMandateId()}");
