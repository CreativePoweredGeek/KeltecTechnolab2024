...
class AIMAuthorizeRequest extends AIMAbstractRequest
{
    ...
    protected function addPayment(\SimpleXMLElement $data)
    {
        ...
        if (($track1 = $creditCard->getTrack1()) && ($track2 = $creditCard->getTrack2())) {
