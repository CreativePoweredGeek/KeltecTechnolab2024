...
namespace CartThrob\Dependency\Omnipay\AuthorizeNet\Model;
...
class CardReference
{
    ...
    {
        $data = array('customerProfileId' => $this->customerProfileId, 'customerPaymentProfileId' => $this->paymentProfileId);
