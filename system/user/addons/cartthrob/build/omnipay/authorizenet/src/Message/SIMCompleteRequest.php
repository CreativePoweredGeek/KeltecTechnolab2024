...
class SIMCompleteRequest extends SIMAbstractRequest
{
    ...
    public function getMd5Hash()
    {
        ...
        $key = array($this->getHashSecret(), $this->getApiLoginId(), $transactionReference, $amount);
