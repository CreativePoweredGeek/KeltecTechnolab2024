...
use CartThrob\Dependency\Omnipay\AuthorizeNet\Message\AIMAuthorizeRequest;
use CartThrob\Dependency\Omnipay\AuthorizeNet\Message\AIMCaptureOnlyRequest;
use CartThrob\Dependency\Omnipay\AuthorizeNet\Message\AIMCaptureRequest;
use CartThrob\Dependency\Omnipay\AuthorizeNet\Message\Query\AIMPaymentPlanQueryResponse;
use CartThrob\Dependency\Omnipay\AuthorizeNet\Message\AIMPurchaseRequest;
use CartThrob\Dependency\Omnipay\AuthorizeNet\Message\AIMRefundRequest;
use CartThrob\Dependency\Omnipay\AuthorizeNet\Message\AIMVoidRequest;
use CartThrob\Dependency\Omnipay\AuthorizeNet\Message\Query\AIMPaymentPlansQueryRequest;
use CartThrob\Dependency\Omnipay\AuthorizeNet\Message\Query\QueryResponse;
...
class AIMGateway extends AbstractGateway
{
    ...
    {
        return array('apiLoginId' => null, 'transactionKey' => null, 'testMode' => \false, 'developerMode' => \false, 'hashSecret' => null, 'liveEndpoint' => 'https://api2.authorize.net/xml/v1/request.api', 'developerEndpoint' => 'https://apitest.authorize.net/xml/v1/request.api');
    }
    ...
    {
        return $this->createRequest(AIMAuthorizeRequest::class, $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest(AIMCaptureRequest::class, $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest(AIMCaptureOnlyRequest::class, $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest(AIMVoidRequest::class, $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest(AIMRefundRequest::class, $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest(Message\Query\AIMPaymentPlansQueryRequest::class, $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest(Message\Query\AIMPaymentPlanQueryRequest::class, $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest(Message\Query\QueryRequest::class, $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest(Message\Query\QueryBatchRequest::class, $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest(Message\Query\QueryBatchDetailRequest::class, $parameters);
    }
    /**
     * @param array $parameters
    ...
    {
        return $this->createRequest(Message\Query\QueryDetailRequest::class, $parameters);
    }
}
