...
<div class="box table-list-wrap">
    ...
    <fieldset class="tbl-search right">
        <a class="btn tn action" href="<?php echo ee('CP/URL')->make('addons/settings/cartthrob/tax-db'); ?>"><?php echo lang('ct.route.tax.standalone_tax_database'); ?></a>
    </fieldset>
    <h1><?php echo lang('tax_plugins'); ?></h1>
