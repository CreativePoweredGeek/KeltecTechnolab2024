...
$config['cartthrob_default_settings'] = [
    ...
    'enabled_gateways' => [
        'Cartthrob_ct_offline_payments' => 'Cartthrob_ct_offline_payments',
    ],
    'low_stock_level' => '5',
    'send_email' => '1',
...
<p>Per seacula quarta decima et quinta decima eodem modo typi qui nunc nobis? Cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim? Adipiscing elit sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat ut. Claritas est etiam processus dynamicus qui sequitur mutationem consuetudium lectorum mirum est notare quam. Ea commodo consequat duis autem vel eum iriure dolor in hendrerit in?</p>',
    ...
    'notifications' => [
        ...
        [
            ...
            'email_from' => 'you@example.com',
            'email_to' => 'you@example.com',
            'template' => 'store/email_low_stock',
            'event' => 'low_stock',
            'status_start' => 'ANY',
            'status_end' => 'ANY',
            'email_type' => 'html',
        ...
        [
            ...
            'email_from' => 'you@example.com',
            'email_to' => 'you@example.com',
            'template' => 'store/email_status_change',
            'event' => '',
            'status_start' => 'ANY',
            'status_end' => 'ANY',
            'email_type' => 'html',
    ...
    'Cartthrob_dev_template_settings' => [
        'mode' => 'always_succeed',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_authorize_net_sim_settings' => [
        'email_customer' => 'no',
        'mode' => 'test',
        'tax_inclusive' => 'Y',
        'api_login' => '',
    ...
    'Cartthrob_anz_egate_settings' => [
        'access_code' => '',
        'merchant_id' => '',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_beanstream_direct_settings' => [
        'merchant_id' => '',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_echo_nvp_settings' => [
    ...
    'Cartthrob_thirdparty_nab_transact_settings' => [
        'merchant_id' => 'XYZ0010',
        'password' => 'abcd1234',
        'test_mode' => 'test',
        'test_response' => '200',
    ...
    'Cartthrob_ogone_direct_settings' => [
        'mode' => 'test',
        'pspid_live' => '',
        'pspid_test' => '',
        'api_userid' => '',
    ...
    'Cartthrob_transaction_central_settings' => [
        'merchant_id' => '',
        'reg_key' => '',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_ct_pay_by_account_settings' => [
        'processing_status' => 'complete',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_cartthrob_direct_settings' => [
        'username' => '',
        'password' => '',
        'dev_username' => '',
        'dev_password' => '',
    ...
    'Cartthrob_quantum_settings' => [
        'gateway_login' => '',
        'restrict_key' => '',
        'email_customer' => '0',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_eway_settings' => [
    ...
    'Cartthrob_moneris_direct_settings' => [
        'store_id' => '',
        'api_token' => '',
        'avs' => 'no',
        'mode' => 'test',
    ...
    'Cartthrob_ct_offline_payments_settings' => [
        'processing_status' => 'complete',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_ct_pay_by_check_settings' => [
        'processing_status' => 'complete',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_ct_pay_by_phone_settings' => [
        'processing_status' => 'complete',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_paypal_standard_settings' => [
        'client_id' => '',
        'secret' => '',
        'sandbox_client_id' => '',
        'sandbox_secret' => '',
    ...
    'Cartthrob_authorize_net_settings' => [
        'mode' => 'test',
        'api_login_id_test' => '',
        'api_transaction_key_test' => '',
        'api_public_client_key_test' => '',
        'api_login_id_live' => '',
        'api_transaction_key_live' => '',
        'api_public_client_key_live' => '',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_thirdparty_psigate_settings' => [
        'mode' => 'test',
        'test_mode_response' => 'R',
        'store_key' => '',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_worldpay_redirect_settings' => [
        'installation_id' => '',
        'test_mode' => 'test',
        'order_complete_template' => 'cart/.footer_nav',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_realex_remote_settings' => [
        'your_merchant_id' => '',
        'your_secret' => '',
        'gateway_fields_template' => '',
    ],
    'currency_code' => 'GBP',
    'Cartthrob_sage_settings' => [
        'mode' => 'test',
        'vendor_name' => '',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_sage_s_settings' => [
        'profile' => 'NORMAL',
        'mode' => 'test',
        'vendor_name' => '',
        'gateway_fields_template' => '',
    ],
    'Cartthrob_sage_us_settings' => [
        'test_mode' => 'test',
        'm_id' => '',
        'm_key' => '',
        'm_test_id' => '',
    ...
    'Cartthrob_ct_save_order_settings' => [
        'processing_status' => 'complete',
        'gateway_fields_template' => '',
    ],
    'last_order_number' => '0',
    'Cartthrob_shipping_by_location_price_threshold_settings' => [
        'mode' => 'rate',
    ...
    'Cartthrob_shipping_by_location_quantity_threshold_settings' => [
        'mode' => 'price',
        'location_field' => 'shipping_country_code',
        'backup_location_field' => 'country_code',
        'thresholds' => [
    ...
    'Cartthrob_shipping_by_location_weight_threshold_settings' => [
        'mode' => 'rate',
    ...
    'Cartthrob_shipping_by_price_threshold_settings' => [
        'mode' => 'price',
        'thresholds' => [
            [
                'rate' => '',
    ...
    'Cartthrob_shipping_by_quantity_threshold_settings' => [
        'mode' => 'price',
        'thresholds' => [
            [
                'rate' => '',
    ...
    'Cartthrob_shipping_by_weight_global_rate_settings' => [
        'rate' => '',
    ],
    'Cartthrob_shipping_by_weight_threshold_settings' => [
        'mode' => 'price',
        'thresholds' => [
            [
                'rate' => '',
    ...
    'Cartthrob_shipping_flat_rates_settings' => [
        'rates' => [
            [
                'short_name' => '',
                'title' => '',
    ...
    'Cartthrob_shipping_per_location_rates_settings' => [
        'default_rate' => '',
        'default_type' => 'flat',
    ...
    'Cartthrob_shipping_single_flat_rate_settings' => [
        'rate' => '',
    ],
    'Cartthrob_tax_default_plus_quebec_settings' => [
        'tax_gst' => '5',
        'tax_qst' => '8.5',
    ...
    'Cartthrob_tax_default_settings' => [
        'use_tax_table' => 'no',
        'tax_settings' => [
            [
                'name' => 'Missouri',
    ...
    'Cartthrob_tax_standard_settings' => [
        'default_tax' => '8',
    ],
    'use_profile_edit' => true,
    'allow_fractional_quantities' => false,
    'update_inventory_when_editing_order' => false,
    'admin_checkout_groups' => [1],
    'msm_show_all' => false,
    'max_rebill_attempts' => 4,
    'subscription_rebill_tax' => true,
    'subscription_rebill_shipping' => true,
    'subscription_rebill_discount' => true,
    'exempt_discount_from_tax' => false,
    // if set to false, subtotal is taxed on subtotal - discount. If set to TRUE, then subtotal is taxed without the discount applied
    'round_tax_only_on_subtotal' => false,
    // if set to TRUE, then tax is only rounded at the very end. This may cause line item total not to equal total of otehr totals, but tax calculation is more accurrate.. you won't lose tenths of cents due to early/often rounding

    'idempotency_enabled' => true,
    'idempotency_field_name' => 'ct_idempotency', // the name of the hidden POST field that contains our token
];
