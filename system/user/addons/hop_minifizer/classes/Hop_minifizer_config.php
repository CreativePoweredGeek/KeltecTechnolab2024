...
class Hop_minifizer_config
{
    ...
    public function init($override = false)
    {
        ...
        // Test: Legacy backwards-compatibility
        if (empty($settings)) {
    ...
    {
        return ($this->$setting == 'yes' || $this->$setting == 'y' || $this->$setting === true) ? true : false;
    }
    // ------------------------------------------------------
     ...
     * Same as doing $Hop_minifizer_config->settings = [];
     *
     * @return  Object  $this
     */
