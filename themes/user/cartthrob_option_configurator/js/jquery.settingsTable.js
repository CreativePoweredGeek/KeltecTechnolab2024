	...
	$.fn.settingsTable = function(options) {
		...
		return this.each(function() {
			...
			if (options.deleteSelector != null) {
				$table.on("click", options.deleteSelector, function(e){
					e.preventDefault();
			...
			if (options.addFullSelector != null) {
				$(document).on("click", options.addFullSelector, function(e) {
					e.preventDefault();
			...
			if (options.addSelector != null) {
				$table.on("click", options.addSelector, function(e) {
					e.preventDefault();
